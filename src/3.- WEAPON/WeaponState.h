...
namespace Weapon
{
	...
	public:
		...
		// Proyectil réplica en vuelo durante el ciclo actual (lanzada,
		// clavada o regresando). Lo fija 4.- THROW al lanzar; lo usará
		// 5.- RETURN para tomar control de ese objeto en concreto al
		// iniciar el regreso.
